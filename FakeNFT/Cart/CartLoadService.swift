...
enum Сonstants {
    static let ordersAPI: String = "https://d5dn3j2ouj72b0ejucbl.apigw.yandexcloud.net/api/v1/orders/1"
    static let nftAPI: String = "https://d5dn3j2ouj72b0ejucbl.apigw.yandexcloud.net/v1/nft/"
    static let defaultURL: String = "https://d5dn3j2ouj72b0ejucbl.apigw.yandexcloud.net/v1/"
    static let currencies: String = "https://d5dn3j2ouj72b0ejucbl.apigw.yandexcloud.net/api/v1/currencies"
    static let putOrders: String = "https://d5dn3j2ouj72b0ejucbl.apigw.yandexcloud.net/api/v1/orders/1/payment/"
}
