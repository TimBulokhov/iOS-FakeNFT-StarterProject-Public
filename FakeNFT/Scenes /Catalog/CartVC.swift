...
//    MARK: - properties
    var cartItems: [NFT] = [NFT(image: UIImage(named: "april"), 
                                name: "April",
                                rating: UIImage(named: "1stars"),
                                price: "1,78"),
                            NFT(image: UIImage(named: "greena"), 
                                name: "Greena",
                                rating: UIImage(named: "3stars"),
                                price: "1,78"),
                            NFT(image: UIImage(named: "spring"), 
                                name: "Spring",
                                rating: UIImage(named: "5stars"),
                                price: "1,78")]
